...
def _get_isaid_visual_demo_meta():
...
def register_isaid_visual_demo(root):
    root = os.path.join(root, "SkySA")
    meta = _get_isaid_visual_demo_meta()
    ...
    for name in ["train", "test"]:
        ...
        all_name = f"isaid_visual_demo_{name}"
...
register_isaid_visual_demo(_root)
