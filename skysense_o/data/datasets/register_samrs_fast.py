...
color_mapping = {}
class_text = 'datasets/samrs_fast/samrs_fast.json'
retrieved_result_path = 'datasets/samrs_fast/o1.json'
...
def register_samrs_fast(root):
    meta = _get_meta()
    root = os.path.join(root, "samrs_fast")
