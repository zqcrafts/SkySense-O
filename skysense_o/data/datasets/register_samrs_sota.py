...
color_mapping = {}
class_text = 'datasets/samrs_sota/samrs_sota.json'
retrieved_result_path = 'datasets/samrs_sota/o1.json'
...
def register_samrs_sota(root):
    meta = _get_meta()
    root = os.path.join(root, "samrs_sota")
