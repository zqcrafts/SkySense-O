...
color_mapping = {}
class_text = 'datasets/samrs_sior/samrs_sior.json'
retrieved_result_path = 'datasets/samrs_sior/o1.json'
...
def register_samrs_sior(root):
    meta = _get_meta()
    root = os.path.join(root, "samrs_sior")
