...
# def setup_env():
    ...
    # module = importlib.import_module('skysense_o.data')
    # build_detection_test_loader = getattr(module, 'build_detection_test_loader')
    # module = importlib.import_module('skysense_o.data')
    # build_detection_train_loader = getattr(module, 'build_detection_train_loader')
    # module = importlib.import_module('skysense_o.data')
    # SkySenseODatasetMapper = getattr(module, 'SkySenseODatasetMapper')
    # module = importlib.import_module('skysense_o.data')
    # SemanticSegmentorWithTTA = getattr(module, 'SemanticSegmentorWithTTA')

    # importlib.import_module('skysense_o.data.build.build_detection_train_loader')
    # importlib.import_module('skysense_o.data.dataset_mapper.SkySenseODatasetMapper')
    # importlib.import_module('skysense_o.data.dataset_mapper.SemanticSegmentorWithTTA')
